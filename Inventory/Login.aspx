<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Inventory.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="form-group">
    ...
    <input type="text" runat="server" class="form-control" id="UserName1" placeholder="User Name"/> 
  </div>
  <div class="form-group">
