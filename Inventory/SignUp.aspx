<%@ Page Title="" Language="C#" MasterPageFile="~/LoginSignup.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Inventory.SignUp" %>
					...
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">WELCOME</h5>
								<p>
									Please sign in if you have an account , if not please sign up to join our website
                                    Thank you ^_^
								</p>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								...
								<fieldset>
									<section>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" runat="server" id="username" name="username" placeholder="Username"/>
											<b class="tooltip tooltip-bottom-right">Needed to enter the website</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-envelope"></i>
											<input type="email" runat="server" id="email" name="email" placeholder="Email address"/>
											<b class="tooltip tooltip-bottom-right">Needed to verify your account</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" runat="server"   id="password" name="password" placeholder="Password"/>
