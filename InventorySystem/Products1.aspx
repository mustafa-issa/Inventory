<%@ Page Title="" Language="C#" MasterPageFile="~/InventoryMaster.Master" AutoEventWireup="true" CodeBehind="Products1.aspx.cs" Inherits="InventorySystem.Products1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h2 class="auto-style2"><asp:Label ID="Label1" runat="server"></asp:Label></h2>
        <br />
      <h1 >  
          Products
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Title" SortExpression="Title">
                    ...
                    <FooterTemplate><asp:TextBox runat="server" ID="txtTitle" ></asp:TextBox></FooterTemplate>
                            </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Description" SortExpression="Description">
                    ...
                    <FooterTemplate><asp:TextBox runat="server" ID="txtDesc" ></asp:TextBox></FooterTemplate>
                            </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Price" SortExpression="Price">
                     ...
                     <FooterTemplate><asp:TextBox runat="server" ID="txtPrice" ></asp:TextBox></FooterTemplate>
                            </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Quantity" SortExpression="Quantity" >
                    ...
                    <FooterTemplate><asp:TextBox runat="server" ID="txtQuantity" ></asp:TextBox></FooterTemplate>
                            </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Status" SortExpression="Status" Visible="false">
                     ...
                     <FooterTemplate><asp:TextBox runat="server" ID="txtStatus" ></asp:TextBox></FooterTemplate>
                            </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Category" SortExpression="Category" >
                     ...
                     <FooterTemplate>
                         <asp:DropDownList CssClass="selectpicker" ID="ddlCategory" runat="server" DataTextField="Name" DataValueField="CategoryId"></asp:DropDownList></FooterTemplate>
                            </asp:TemplateField>
                ...
                <asp:TemplateField>
                     ...
                     <FooterTemplate><asp:Button runat="server" ID="btnSave" Text="ADD NEW PRODUCT" OnClick="btnSave_Click"  CommandName="Footer"  /></FooterTemplate>
                            </asp:TemplateField>
    ...
    <asp:Button ID="Button1" class="btn btn-primary btn-lg" runat="server" Text="Jumb to Category" OnClick="Button1_Click" />
